...
const Div = styled.div`
  ...
  z-index: 4;
`;
const ContactMethods1 = styled.div`
  height: 56px;
  width: 157.7px;
  display: flex;
  flex-direction: column;
...
const TrustedCompanies = styled.div`
  ...
  box-sizing: border-box;
`;
const TrustedByParent = styled.div`
  width: 506.4px;
  height: 70.1px;
  display: flex;
  flex-direction: column;
...
const Project = styled.div`
  ...
  gap: var(--gap-51xl);
`;
const TestimonialsParent = styled.div`
  position: absolute;
  top: 159px;
  left: 288px;
  width: 688.9px;
